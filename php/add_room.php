<?php  
 ...
 if($save=="yes"){
 	$sql="INSERT INTO room(hotel_id,numbeds,view,havebathroom,price) VALUES ($hotel_id,$numbeds,'$view','$hasbath',$price)";
...
elseif($save=="update"){
	...
	$sql="UPDATE room SET hotel_id=$hotel_id, numbeds=$numbeds, view='$view', havebathroom='$hasbath', price=$price WHERE id=$fieldId";
	$result = mysqli_query($con,$sql);
	if (!$result)
  	{
  		die('Неуспешно въвеждане ' . mysqli_error($con));
